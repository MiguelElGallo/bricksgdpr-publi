...
!!! tip "Run the invoice lesson in your browser"
    [Launch the invoice lesson](https://miguelelgallo.github.io/bricksgdpr-publi/tutorial/?lesson=invoice-quarantine)
    to edit the focused invoice model, run a real dbt build against DuckDB, and inspect its accepted
    and quarantined rows without credentials or a Databricks workspace. This teaching edition
    demonstrates portable classification behavior only. Continue below for the canonical
    Databricks version of the lesson.

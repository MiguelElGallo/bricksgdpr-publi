...
| `assert_layer_model_generators` | All twelve layer-kind combinations emit required configuration, lineage, mapping masks/tags, policy, fresh-FACT flag, and governed erased-member fragments |
